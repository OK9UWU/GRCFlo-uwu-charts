...
class cyclo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "cyclo")
        ...
        # Variables
        ##################################################
        self.symrate = symrate = 400e3
        self.samp_rate = samp_rate = 3e6
        self.sps = sps = samp_rate/symrate
        ...
        self.qtgui_freq_sink_x_1.set_y_axis((-90), (-20))
        ...
        self.filter_fft_rrc_filter_0 = filter.fft_filter_ccc(1, firdes.root_raised_cosine(1, samp_rate, symrate, 0.35, 61), 1)
        ...
        self.blocks_interleaved_short_to_complex_0 = blocks.interleaved_short_to_complex(False, False,128)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/tmp/WSF-1stpass-2024-04-13_05-12-28_3000000SPS_2252500000Hz.s16', True, 0, 0)
        ...
        self.connect((self.filter_fft_rrc_filter_0, 0), (self.digital_costas_loop_cc_0, 0))
    ...
    def set_symrate(self, symrate):
        ...
        self.set_sps(self.samp_rate/self.symrate)
        self.filter_fft_rrc_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, self.symrate, 0.35, 61))
...
def main(top_block_cls=cyclo, options=None):
